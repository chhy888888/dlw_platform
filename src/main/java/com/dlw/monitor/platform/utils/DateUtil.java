...
public class DateUtil {
	...
	* @author luguosui
     ...
     * @param beginDate
     * @param endDate
     * @return  "相隔年份"+p.getYears()+"相隔月份："+p.getMonths()
     */
    public static Period getDiff(Date beginDate,Date endDate){
	...
	public static String addMonth(String date,int month){
    	...
    	try {
    		...
    		calendar.setTime(parse); calendar.add(Calendar.MONTH, month);
    ...
    public static void main(String[] args) {
    	...
    	String stime = "2017-04-16 14:04:00";
    	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    	Long result;
		try {
			result = (sdf.parse(stime).getTime()-new Date().getTime())/(24*60*60*1000);
