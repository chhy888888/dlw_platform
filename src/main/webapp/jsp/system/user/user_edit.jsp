...
<script type="text/javascript">
	...
	function hasU(){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>manager/user/hasU.do',
	...
	function hasE(USERNAME){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>manager/user/hasE.do',
	...
	function hasN(USERNAME){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>manager/user/hasN.do',
...
<body>
	<form action="manager/user/${msg }.do" name="userForm" id="userForm" method="post">
		...
		<table>
			...
			<tr class="info">
				...
				<c:forEach items="${roleList}" var="role">
					<c:if test="${role.ROLE_ID == pd.ROLE_ID }">
