...
<div class="span12">
	<div class="tabbable">
            <ul class="nav nav-tabs" id="myTab">
              <li class="active"><a data-toggle="tab" href="#home"><i class="green icon-home bigger-110"></i>文字说明</a></li>
              <li class=""><a data-toggle="tab" href="#profile">流程图</a></li>
              
            </ul>
            <div class="tab-content">
			  <div id="home" class="tab-pane active">
				<center> <!-- <img alt="" src="static/images/sm.png">--></center>
			  </div>
			  <div id="profile" class="tab-pane">
				<center> <!-- <img alt="" src="static/images/lct.png"> --></center>
			  </div>
            </div>
	</div>
 </div>
