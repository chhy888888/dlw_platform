...
<script type="text/javascript">
  function ceshi(){
   window.location.href="test_test";
  }
</script>
</head>
<body>
	...
	<div
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © CIDP
							2015</span></font>
				</div>
			</div>
		</div>
				...
				$.ajax({
					...
					success: function(data){
						if("success" == data.data.result){
							saveCookie();
							window.location.href="<%=basePath%>manager/sysmain/index";
						}else if("usererror" == data.data.result){
							$("#loginname").tips({
								side : 1,
								msg : "用户名或密码有误",
								bg : '#FF5080',
							...
							$("#loginname").focus();
						}else if("codeerror" == data.data.result){
							$("#code").tips({
								side : 1,
								msg : "验证码输入有误",
								bg : '#FF5080',
