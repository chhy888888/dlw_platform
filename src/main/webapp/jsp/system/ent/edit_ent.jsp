...
<body>
	<form action="system/ent/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="cul_id" id="cul_id" value="${customer.cul_id}"/>
		<input type="hidden" name="ent_id" id="ent_id" value="${ent.ent_id}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover" >
			...
			<tr>
				...
				<td style="width:35%;"><input type="text" name="ent_address" id="ent_address" value="${ent.ent_address}" maxlength="255" placeholder="公司地址" title="公司地址"/></td>
			
				<td style="width:15%;text-align: right;padding-top: 13px;">邮政编码:</td>
				<td style="width:35%;" ><input type="text" name="ent_postcode" id="ent_postcode" value="${ent.ent_postcode}" maxlength="255" placeholder="邮政编码" title="邮政编码"/></td>
			</tr>
			<tr>
				<td style="width:15%;text-align: right;padding-top: 13px;">法人代表:</td>
				<td style="width:35%;"><input type="text" name="ent_legal_representative" id="ent_legal_representative" value="${ent.ent_legal_representative}" maxlength="20" placeholder="法人代表" title="法人代表"/></td>
			...
			<tr>
				...
				<td style="width:35%;"><input type="text" name="ent_contactor" id="ent_contactor" value="${ent.ent_contactor}" maxlength="20" placeholder="联系人" title="联系人"/></td>
			...
			<tr>
				...
				<input class="span10 date-picker" style="width:200px;" name="ent_createdate" id="ent_createdate" value="<fmt:formatDate value="${ent.ent_createdate}" pattern="yyyy-MM-dd"/>" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="成立日期" title="成立日期"/>
			...
			<tr>
				...
				<td style="width:35%;"><input type="text" name="ent_annual_turnover" id="ent_annual_turnover" value="${ent.ent_annual_turnover}" maxlength="20" placeholder="年营业额" title="年营业额"/></td>
				<td style="width:15%;text-align: right;padding-top: 13px;">主要出口国家:</td>
				<td style="width:35%;"><input type="text" name="ent_main_export_contries" id="ent_main_export_contries" value="${ent.ent_main_export_contries}" maxlength="10" placeholder="主要出口国家" title="主要出口国家"/></td>
			</tr>
			<tr>
				<td style="width:15%;text-align: right;padding-top: 13px;">主要出口产品:</td>
				<td style="width:35%;"><input type="text" name="ent_main_export_product" id="ent_main_export_product" value="${ent.ent_main_export_product}" maxlength="20" placeholder="年营业额" title="年营业额"/></td>
				<td style="width:15%;text-align: right;padding-top: 13px;">结汇融资专用账号:</td>
				<td style="width:35%;">
				<input type="radio" name="ent_open_bankaccount" value="1" <c:if test='ent.ent_open_bankaccount == 1'>checked</c:if>>开通
				<input type="radio" name="ent_open_bankaccount" value="0" <c:if test='ent.ent_open_bankaccount == 1'>checked</c:if>>不开通
				</td>
			</tr>
			<tr>
