...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="manager/financing/listEnterpriseServiceCharge.do" method="post" name="servicechargeForm" id="servicechargeForm">
				<input type="hidden" name="fc_id" id="fc_id">
				<input type="hidden" name="cul_type" id="1">
			<table>
				<tr>
							...
							<tr>
								...
								<td style="width: 60px;">
									<div class='hidden-phone visible-desktop btn-group'>
										...
										<c:if test="${QX.edit == 1 }">
											<a class='btn btn-mini btn-info' title="确认付款" onclick="editUser('${sc.fc_id }');"><i class='icon-edit'></i></a>
										</c:if>
									</div>
								</td>
							</tr>
