...
$(function(){if('sysmain'== locat[3]){locat =  locat[0]+'//'+locat[2];}else{locat =  locat[0]+'//'+locat[2]+'/'+locat[3];};});
...
$(function(){
	...
	$("#skin-colorpicker").ace_colorpicker().on("change",function(){
		...
		hf(b);
		var url = locat+'/head/setSKIN.html?SKIN='+b+'&tm='+new Date().getTime();
...
function editUserH(){
	 ...
	 diag.Drag=true;
	 diag.Title ="个人资料";
	 diag.URL = locat+'/system/user/goEditU.do?USER_ID='+USER_ID+'&fx=head';
	 diag.Width = 225;
	 diag.Height = 389;
...
//切换菜单
function changeMenu(){
	window.location.href=locat+'/sysmain/yes';
}
